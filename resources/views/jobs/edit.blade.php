<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl" >
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data" >
            ...
            <x-inputs.text-area id="description" name="description" label="Job Description" placeholder="We are seeking a skilled and motivated Software Developer to join our growing development team..." cols="30" rows="7" :value="old('description', $job->description)" />
            ...
            <x-inputs.text id="company_website" name="company_website" type="url" label="Company Website" placeholder="Enter website" :value="old('company_website', $job->company_website)" />
            ...
            <x-inputs.text id="contact_email" name="contact_email" label="Contact Email" type="email" placeholder="Email where you want to receive applications" :value="old('contact_email', $job->contact_email)" />
