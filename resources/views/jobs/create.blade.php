<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl" >
        ...
        <form method="POST" action="/jobs" enctype="multipart/form-data" >
            ...
            <x-inputs.text-area id="description" name="description" label="Job Description" placeholder="We are seeking a skilled and motivated Software Developer to join our growing development team..." cols="30" rows="7" />
